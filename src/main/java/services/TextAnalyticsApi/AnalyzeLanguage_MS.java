...
public class AnalyzeLanguage_MS {
    ...
    static class DetectLanguage  {
        ...
        static String path = "/text/analytics/v2.0/languages"; // of text/analytics/v2.0
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                documents.add ("1",  docxReader.readFile("src\\main\\Aanvullende_Files\\MS1.docx\\")); //"I really enjoy the new XBox One S. It has a clean look, it has 4K/HDR resolution and it is affordable.");
